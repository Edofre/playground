            ...
            <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                ...
                <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex mb-3">
                        ...
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-gray-100 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-auto">
                            {{ __('Login') }}
                        </button>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center">
                        ...
                        <a class="text-sm text-blue-500 hover:text-blue-700 whitespace-no-wrap no-underline" href="{{ route('password.request') }}">
                ...
                <div class="bg-gray-200 text-xs text-center italic text-gray-700 py-3">
